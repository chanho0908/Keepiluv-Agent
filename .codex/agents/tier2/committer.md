...
커밋은 사용자의 명시적 승인 후에만 실행합니다.

커밋 전 반드시 다음 내용을 먼저 보고하고 승인을 기다립니다:
- `git status` 기준 변경 파일 목록
...
사용자가 이미 커밋 실행을 승인한 경우에만 아래 작업 프로세스의 4단계를 실행합니다.
...
5. **도메인 용어**: 도메인 개념이 포함되면 `wiki/reference/domain-glossary.md`의 공식 용어 사용
